...
<form action="profile-pic-test" method="post" id="update-profile" enctype="multipart/form-data">
                ...
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <input type="file" name="profile-pic" class="form-control" value="<?php if(!empty($_SESSION['user']['pic'])) echo ($_SESSION['user']['pic'])?>">
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="row">
                            <div class="col-sm-12 text-left">
                                ...
                                <input class="btn btn-info" name="edit-pic" type="submit" value="Save">    
