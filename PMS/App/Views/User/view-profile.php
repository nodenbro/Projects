...
<html lang="en">
    ...
    <?php $id = $_POST['view-id']?>

    <h1><?php echo $id ?></h1>

    <?php $profile = Application::get()->where('user_id', $id)?>
    <?php $user = User::findOrFail($id) ?>

    <title>Profile - <?php echo $user->firstname . " " . $user->lastname?></title>
    ...
    <div class="main-body">
            ...
            <div class="col-md-4 mb-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <img src="uploads/<?php echo ($user->pic)?>" alt="Admin" class="rounded-circle" width="150" height="150">
                        <div class="mt-3">
        ...
        <div class="card mt-3">
            <ul class="list-group list-group-flush">
                ...
                <?php $profile = Profile::get()->where('user_id', $id)->first(); ?>
                <?php if(!empty($profile->user_id) && $user->id == $profile->user_id):?>
