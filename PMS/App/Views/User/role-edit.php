...
<form action="update-role" method="post" id="update-role">
    ...
    <div class="col-md-8">
        <div class="card mb-3">
                <div class="card-body">
                        <div class="row">
                            <div class="col-sm-3">
                            <h6 class="mb-0">Front End Development</h6>
                            </div>
                            <div class="col-sm-9 text-secondary">
                            <select name="front_end" class="form-control">
                                <option value="1%">No Knowledge</option>
                                <option value="20%">Beginner</option>
                                <option value="70%">Intermediate</option>
                                <option value="100%">Senior</option>
                            </select>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="col-sm-3">
                            <h6 class="mb-0">Back End Development</h6>
                            </div>
                            <div class="col-sm-9 text-secondary">
                            <select name ="back_end" class="form-control">
                                <option value="1%">No Knowledge</option>
                                <option value="20%">Beginner</option>
                                <option value="70%">Intermediate</option>
                                <option value="100%">Senior</option>
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                            <h6 class="mb-0">Game Development</h6>
                            </div>
                            <div class="col-sm-9 text-secondary">
                            <select name="game_dev" class="form-control">
                                <option value="1%">No Knowledge</option>
                                <option value="20%">Beginner</option>
                                <option value="70%">Intermediate</option>
                                <option value="100%">Senior</option>
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                            <h6 class="mb-0">Cloud Engineer</h6>
                            </div>
                            <div class="col-sm-9 text-secondary">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9 text-secondary">
                            <select name="data_analyst" class="form-control">
                                <option value="1%">No Knowledge</option>
                                <option value="20%">Beginner</option>
                                <option value="70%">Intermediate</option>
                                <option value="100%">Senior</option>
                        ...
                        <div class="row">
                            <div class="col-sm-12  text-left">
                                <!-- <a class="btn btn-info " target="__blank" href="edit-user">Save Changes</a> -->
                                <!-- <div><a class="btn btn-info " href="javascript:;" onclick="document.getElementById('update-profile').submit();">Save Changes</a></div> -->
                                <input class="btn btn-info" name="update-role" type="submit" value="Save">
                                <!-- <button class="btn btn-info text-left" onclick="history.back()">Go Back</button> -->



                                <!-- <a target="__blank" href="profile">Back</a> -->
                            </div>
                        </div>
                    </form>
